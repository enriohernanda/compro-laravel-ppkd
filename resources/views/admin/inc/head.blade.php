<!-- Favicon -->
    ...
    <link rel="stylesheet" href="{{ asset('adm/assets/vendor/css/theme-default.css') }}" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="{{ asset('adm/assets/css/demo.csss') }}" />
